...
<style>
body {font-family: arial;font-size: 15px;line-height: 18px;margin: 0 auto;width: 900px;}
a{color:#3399FF;}
...
.content{background: #f2f2ff;border: 6px solid #3399ff;font-size: 16px;line-height: 22px;margin-bottom: 3px;margin-top: 3px;min-height: 600px;overflow: hidden;padding: 10px;}
...
.mainleft{border-right: 1px dotted #999;float: left;margin-right: 16px;width: 250px;}
.mainright{float:right;width:600px;}
...
input[type="text"] {border:1px solid #ddd;margin-bottom:5px;padding:5px;width:150px;font-size:16px}
